...
nlu_interpreter =RasaNLUInterpreter('./models/nlu/current') #train rasa_nlu
action_endpoint = EndpointConfig(url="http://localhost:5055/webhook")
agent = Agent.load('./models/nlu/dialogue', interpreter = nlu_interpreter,action_endpoint = action_endpoint) #train rasa_core
